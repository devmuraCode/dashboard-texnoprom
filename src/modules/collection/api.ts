...
export const Single = ({
  ...
  http.request.get(`/collections/${id}`);
...
export const Create = ({
  ...
  return http.request.post("/collections/", formData, {
    headers: {
...
export const Update = ({
  ...
  return http.request.put(`/collections/${id}`, formData, {
    headers: {
      "Content-Type": "multipart/form-data",
    },
  });
...
export const Delete = ({
  ...
  return http.request.delete(`/collections/${id}/`);
};